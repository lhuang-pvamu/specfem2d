                              ...
                              realw* b_deltatover2_F)
{
    ...
    UpdateDispVeloc_kernel(mp->d_displ,mp->d_veloc,mp->d_accel,size,deltat,deltatsqover2,deltatover2);
    ...
    if (mp->simulation_type == 3) {
        ...
        //<<<grid,threads,0,mp->compute_stream>>>
        UpdateDispVeloc_kernel(mp->d_b_displ,mp->d_b_veloc,mp->d_b_accel,size,b_deltat,b_deltatsqover2,b_deltatover2);
    }
}
                                 ...
                                 int* UNDO_ATTENUATION_AND_OR_PML)
{
    ...
    if(!(*UNDO_ATTENUATION_AND_OR_PML && *compute_b_wavefield)) {
        //<<<grid,threads,0,mp->compute_stream>>>
        UpdatePotential_kernel(mp->d_potential_acoustic,
    ...
    if (mp->simulation_type == 3 && *compute_b_wavefield) {
        ...
        realw b_deltatover2 = *b_deltatover2_F;
        //<<<grid,threads,0,mp->compute_stream>>>
        UpdatePotential_kernel(mp->d_b_potential_acoustic,
                     ...
                     realw* b_deltatover2_F) 
{
    ...
    //<<< grid, threads,0,mp->compute_stream>>>
    kernel_3_veloc_omp_device(mp->d_veloc, mp->d_accel, size,deltatover2);
    if (mp->simulation_type == 3) {
        realw b_deltatover2 = *b_deltatover2_F;
        //<<< grid, threads,0,mp->compute_stream>>>
        kernel_3_veloc_omp_device(mp->d_b_veloc, mp->d_b_accel, size,b_deltatover2);
    }
}
